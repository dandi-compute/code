...
-   Prefer pre-stripping parsed file lines and assigning computed return values to named locals before `return` when this improves readability and debugger breakpoint placement
