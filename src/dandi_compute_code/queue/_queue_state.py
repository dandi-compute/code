...
from ._globals import _AIND_EPHYS_PARAMS_REGISTRY, _DURATION_PART_RE, _QUEUE_CONFIG_SCHEMA_PATH
...
# This module deliberately reimplements the behavior of the sibling queue helper
# functions inline so that the ``QueueState`` / ``JobEntry`` model is fully
# self-contained. The duplication is temporary, kept until the procedural
# functions are removed in favor of this model.
