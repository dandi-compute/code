...
@pytest.mark.parametrize(
    ...
    [
        ...
        (["queue", "refresh", "--help"], "Regenerate state.tsv/archive_state.tsv and republish state.tsv."),
        (["queue", "clean", "--help"], "Delete unsubmitted capsules that are no longer present in the queue."),
        (["queue", "stats", "--help"], "Write aggregate queue statistics from state.tsv and timeline reports."),
