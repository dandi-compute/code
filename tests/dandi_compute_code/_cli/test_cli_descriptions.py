...
@pytest.mark.parametrize(
    ...
    [
        ...
        (["queue", "refresh", "--help"], "Republish state.tsv into both Dandisets."),
        (["queue", "clean", "--help"], "Delete unsubmitted capsules that are no longer present in the queue."),
        (["queue", "stats", "--help"], "Publish aggregate queue statistics from the live queue state."),
        ...
        (["issues", "dump", "--help"], "Scan nextflow and slurm logs and publish per-capsule issue records."),
